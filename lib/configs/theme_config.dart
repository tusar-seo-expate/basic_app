...
class ThemeConfig{
 ...
 static Color primaryBtnColor=accentColor;
 static Color secondaryBtnColor=const Color.fromRGBO(255, 124, 8,1);
 static Color optionalBtnColor=const Color.fromRGBO(0, 0, 0, 1.0);

//Optional Color
  static Color onError=const Color.fromRGBO(225, 20, 20, 1.0);
  static Color surfaceLight=const Color.fromRGBO(239, 239, 239, 1.0);
  ...
  static Color darkGrey = Color.fromRGBO(27,27,27, 1);
  static Color extraDarkGrey = Color.fromRGBO(34, 34, 35, 1.0);
